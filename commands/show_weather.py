...
owm = pyowm.OWM('d4c69ef5154d6694cb4aac30b9e034a6')
...
def main():
    ...
    while True:
        ...
        try:
            ...
            HBlackimage = Image.new('1', (epd2in9.EPD_HEIGHT, epd2in9.EPD_WIDTH), 255)  # 298*126
           
            print("Drawing")
            drawblack = ImageDraw.Draw(HBlackimage)
            font24 = ImageFont.truetype(os.path.join(fontdir, 'arial.ttf'), 24)
            font16 = ImageFont.truetype(os.path.join(fontdir, 'arial.ttf'), 16)
            font20 = ImageFont.truetype(os.path.join(fontdir, 'arial.ttf'), 20)
            fontweather = ImageFont.truetype(os.path.join(fontdir, 'meteocons-webfont.ttf'), 30)
            fontweatherbig = ImageFont.truetype(os.path.join(fontdir, 'meteocons-webfont.ttf'), 60)
        ...
        time.sleep(10) # Wake up every 10 minutes to update weather display
